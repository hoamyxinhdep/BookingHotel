...
<div class="BookingForm">
    ...
    <form action="changePass" method="POST" >
        ...
        <input value=""type="password"  name="password" placeholder="Enter your password"required ><br>
        <p style="color: red">${requestScope.USER_ERROR.getNameError()}</p>
        <label for="customerName">New Password</label>
        <input value=""type="password"  name="newpassword" placeholder="Enter your new password"required ><br>
         <p style="color: red">${requestScope.USER_ERROR.getPasswordError()}</p>
        
        
        <label for="customerName">Confilm New Password</label>
        <input value=""type="password"  name="confpassword" placeholder="Enter your new password again"required ><br>
